---
title: Pricee
description: pricee is a ecommerce price tracker platform that leverages bulk web scraping to create a database of price differences of the same products in difference ecommerce platforms.
