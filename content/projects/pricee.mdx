---
title: Pricee
description: Pricee is a bulk web scraping project that allows users to compare prices of products across multiple websites.
repository: fardeenes7/pricee
date: "2023-05-21"
published: true
image: '/images/projects/pricee/pricee.jpg'
---
# Description
...
- Automatic Bulk web scraper
- Fully automatic scraping for 3 competitor e-commerce websites
- Scheduled scraping using redis, celery and rabbitMQ
- SEO friendly frontend using Next.JS
- Social login (e.g: google, facebook) using JWT token.
