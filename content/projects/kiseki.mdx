...
image: "/images/projects/kiseki/kiseki.jpg"
---

![](/images/projects/kiseki/kiseki.jpg)
...
- Warranty management system with tracking
- User profile with purchase and warranty history
...
1.  Clone the repository to your local machine:
    ...
    ```bash
    git clone https://github.com/fardeenes7/kiseki.git
    ```
...
If you would like to contribute to kiseki, please open a pull request or submit an issue on the GitHub repository.
